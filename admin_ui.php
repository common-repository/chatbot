...
<path id="l4" d="M0 190 L300 190"></path>
    ...
    <section class="<?php esc_attr_e( 'wp-chatbot-tab-container-inner',  'wpbot' );  ?> ">
      <div class="<?php esc_attr_e( 'wp-chatbot-tabs wp-chatbot-tabs-style-flip',  'wpbot' );  ?> ">
        <nav>
          <ul>
            <li class="tab-current" tab-data="started"><a href="<?php echo esc_url($action .'&tab=started',  'wpbot' );  ?> "> <span class="<?php esc_attr_e( 'wpwbot-admin-tab-icon',  'wpbot' );  ?> "> <i class="<?php esc_attr_e( 'fa fa-toggle-on',  'wpbot' );  ?> "> </i> </span> <span class="<?php esc_attr_e( 'wpwbot-admin-tab-name',  'wpbot' );  ?> ">
